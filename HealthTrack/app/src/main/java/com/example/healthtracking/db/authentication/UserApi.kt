...
import com.example.healthtracking.db.exercise_data.ExerciseGetModel
...
interface UserApi {
    ...
    ) : Call<ExerciseDataModel>

    @GET("/get-history-olahraga")
    fun getExercise() : Call<ArrayList<ExerciseGetModel>>
